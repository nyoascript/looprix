...
local function saveConfig()
    local cfg = {
        ...
        DESYNC_ENABLED          = CONFIG.DESYNC_ENABLED,
        AUTO_REACT_STEAL_ENABLED= CONFIG.AUTO_REACT_STEAL_ENABLED,
        ...
        FLOAT_ACTIVE                = CONFIG.FLOAT_ACTIVE,
        ...
        DESYNC_PANEL_VISIBLE        = CONFIG.DESYNC_PANEL_VISIBLE,
        ...
        AUTO_PLAY_KEYBIND           = CONFIG.AUTO_PLAY_KEYBIND and CONFIG.AUTO_PLAY_KEYBIND.Name or nil,
        ...
        AUTO_WALK_KEYBIND           = CONFIG.AUTO_WALK_KEYBIND and CONFIG.AUTO_WALK_KEYBIND.Name or nil,
        TP_DOWN_KEYBIND             = CONFIG.TP_DOWN_KEYBIND and CONFIG.TP_DOWN_KEYBIND.Name or nil,
        AUTO_REACT_STEAL_KEYBIND    = CONFIG.AUTO_REACT_STEAL_KEYBIND and CONFIG.AUTO_REACT_STEAL_KEYBIND.Name or nil,
        -- gui positions
        _guiPositions               = CONFIG._guiPositions,
        _autoPlayOffsets            = CONFIG._autoPlayOffsets,
        _apBasePositions            = CONFIG._apBasePositions,
    }
    pcall(function()
...
local function createSettingsTab(parent)
    ...
    local saveBtn = createElement("TextButton", {
        Size = UDim2.new(1, 0, 0, 44),
        BackgroundColor3 = COLORS.Surface,
        BackgroundTransparency = 0.1,
        Text = "Save Config",
    ...
    createElement("UICorner", { CornerRadius = UDim.new(0, 6), Parent = saveBtn })
    trackStroke(createElement("UIStroke", { Color = COLORS.Accent, Thickness = 1, Transparency = 0.3, ApplyStrokeMode = Enum.ApplyStrokeMode.Border, Parent = saveBtn }))
    trackLabel(saveBtn)
    saveBtn.MouseButton1Click:Connect(function()
        saveConfig()
        S.TweenService:Create(saveBtn, tweenInfoFast, { BackgroundColor3 = COLORS.Accent }):Play()
        task.delay(0.25, function()
            S.TweenService:Create(saveBtn, tweenInfoFast, { BackgroundColor3 = COLORS.Surface }):Play()
        end)
    end)
